...
<div class="layui-tab layui-tab-brief main-tab-container">
    <ul class="layui-tab-title main-tab-title">
      <div class="main-tab-item">考勤信息</div>
      <li><input type="button" value="批量删除" style="margin-left: -20px;" onclick="deleteAbsence()"><img class="icon" src="picture/moredelete.png" width="20" height="20" ></li>      
    </ul>
    <div class="layui-tab-content">
      <div class="layui-tab-item layui-show">
      <form class="layui-form" width=80%>
...
$row=mysql_fetch_row(mysql_query("select count(1) from arrive_time"));
$recordcount=$row[0]; 
?>
...
function refesh() {
    ...
    $(data).each(
      ...
      $("#list").html($("#list").html()
          ...
          +"<td><span>"+values.is_late+"</span></td></tr>"
      );
    }
  );
    var text1 = "是"; 
    var text2 = "否";
    $("table tr td").find('span').each(function(){       
    if($(this).html()==text1){      
    $(this).css({"display":"block","background":"red","color":"#fff","height":"20px","width":"60px","border":"1px solid #fff","border-radius":"4px","text-align":"center","margin-left":"40%"}); 
    $(this).parent().css({"color":"red"});
    $(this).parent().siblings().css({"color":"red"});
    }       
    if($(this).html()==text2){   
    $(this).css({"display":"block","background":"#33ff74","color":"#fff","height":"20px","width":"60px","border":"1px solid #fff","border-radius":"4px","text-align":"center","margin-left":"40%"});   
    }       
    }); 
},
})
